$(FIP_DIR)/bl30_new.bin.enc: $(FIP_DIR)/bl30_new.bin
	$(CURDIR)/fip/gxl/aml_encrypt_gxl --bl3enc --input $(FIP_DIR)/bl30_new.bin

$(FIP_DIR)/bl31.img.enc: $(FIP_DIR)/bl31.img
	$(CURDIR)/fip/gxl/aml_encrypt_gxl --bl3enc --input $(FIP_DIR)/bl31.img

$(FIP_DIR)/bl33.bin.enc: $(FIP_DIR)/bl33.bin
	$(CURDIR)/fip/gxl/aml_encrypt_gxl --bl3enc --input $(FIP_DIR)/bl33.bin

$(FIP_DIR)/bl2.n.bin.sig: $(FIP_DIR)/bl2_new.bin
	$(CURDIR)/fip/gxl/aml_encrypt_gxl --bl2sig --input $(FIP_DIR)/bl2_new.bin \
	--output $(FIP_DIR)/bl2.n.bin.sig

$(FIP_DIR)/u-boot.bin $(FIP_DIR)/u-boot.bin.sd.bin: $(FIP_DIR)/bl30_new.bin.enc $(FIP_DIR)/bl31.img.enc $(FIP_DIR)/bl33.bin.enc $(FIP_DIR)/bl2.n.bin.sig
...
$(FIP_DIR)/bl2_new.bin: $(FIP_DIR)/bl2_acs.bin $(FIP_DIR)/bl21.bin
...
$(FIP_DIR)/bl2_acs.bin: $(FIP_DIR)/bl2.bin $(FIP_DIR)/acs.bin
...
$(FIP_DIR)/bl30_new.bin: $(FIP_DIR)/bl30.bin $(FIP_DIR)/bl301.bin
	$(CURDIR)/fip/blx_fix.sh \
	$(FIP_DIR)/bl30.bin \
	$(FIP_DIR)/zero_tmp \
