...
.PHONY: all
all: $(OUT_DIR)/u-boot-$(UBOOT_TAG).bin

$(OUT_DIR)/u-boot-$(UBOOT_TAG).bin: $(OUT_DIR) $(FIP_DIR)/u-boot.bin.sd.bin
	cp $(FIP_DIR)/u-boot.bin.sd.bin $(OUT_DIR)/u-boot-$(UBOOT_TAG).bin
